...
export const CHORDS: Record<string, ChordDefinition> = {
  major: { name: 'M', intervals: [0, 4, 7], quality: 'Stable, Bright' }, // Changed: Suffix is "M" (e.g., CM)
  ...
  major7: { name: 'maj7', intervals: [0, 4, 7, 11], quality: 'Jazzy, Smooth' }, // Tonal often uses M7 for maj7
  ...
  major6: { name: '6', intervals: [0, 4, 7, 9], quality: 'Sweet, Nostalgic' }, // Tonal might use M6
  ...
  major9: { name: 'maj9', intervals: [0, 4, 7, 11, 14], quality: 'Lush, Dreamy' }, // Tonal might use M9
